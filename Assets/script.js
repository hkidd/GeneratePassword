...
function generatePassword() {
  ...
  var lower = confirm("Would you like lowercase characters?");
    // This concatenates the lowercase letters onto the existing passwordArray, or, onto an empty array if true
  ...
  var special = confirm("Would you like special characters?");
    // This concatenates the special characters onto the existing passwordArray, or, onto an empty array if true
  ...
  var num = confirm("Would you like numbers?");
    // This concatenates the numbers onto the existing passwordArray if true, or, onto the empty passwordArray even if they say no, so that something is given
  ...
  // Random password variable/array generated
  var randomPassword = [];
  ...
  // Finally, return the newly contructed password to be shown on screen
